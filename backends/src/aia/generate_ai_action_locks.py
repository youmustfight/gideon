...
def generate_ai_action_locks(case_id = None):
  return [
    # actions should match a python function name
    AIActionLock(
    ...
    AIActionLock(
      ...
      model_name=AI_MODELS.text_similarity_curie_001.value,
      params={},
      case_id=case_id),
    AIActionLock(
      action=AI_ACTIONS.case_similarity_text_sentences_search.value,
      model_name=AI_MODELS.all_MiniLM_L6_v2.value,
      params={},
      case_id=case_id),
    AIActionLock(
