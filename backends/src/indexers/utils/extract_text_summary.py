...
def extract_text_summary(document_text, use_prompt=None):
    ...
    print(f'INFO (extract_text_summary): document_text_length: {document_text_length} / max_length: {max_length}')
