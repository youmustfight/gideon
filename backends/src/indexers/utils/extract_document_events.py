import textwrap
from models.gpt import gpt_completion, gpt_edit, GTP3_COMPLETION_MODEL_ENGINE_DAVINCI_003
...
async def extract_document_events_v1(document_text):
    ...
    for chunk in chunks:
        ...
        timeline_completion = gpt_completion(
            prompt, max_tokens=500, engine=GTP3_COMPLETION_MODEL_ENGINE_DAVINCI_003)
